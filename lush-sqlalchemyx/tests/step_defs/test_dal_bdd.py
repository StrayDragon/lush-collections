...
@scenario("dal/advanced-update.feature", "only-set allow None 将描述置空")
def test_update_only_set_allow_none() -> None: ...


@scenario("dal/advanced-update.feature", "only-set forbid None 抛出异常")
def test_update_only_set_forbid_none() -> None: ...
