"""V2 同步 DAL — 继承 lush-dal-protocol ABC, 使用 options 参数签名.
...
class SyncReadDALV2(
    ...
    AbstractSyncReadDAL[Session, SyncSQLATableT, DTOModelT],
    AbstractSyncBatchFieldDAL[Session, SyncSQLATableT, DTOModelT],
...
class SyncWriteDALV2(  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    AbstractSyncWriteDAL[Session, SyncSQLATableT, DTOModelT, CUModelT],
    AbstractSyncAdvancedWriteDAL[Session, SyncSQLATableT, CUModelT, SQLAUpdateOptions, SQLAPartialUpdateOptions],
...
class SyncBaseDALV2(  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    AbstractSyncLockDAL[Session, SyncSQLATableT, CUModelT, SQLALockOptions, SQLAOptimisticLockOptions],
    AbstractSyncRawSQLDAL[Session],
    Generic[SyncSQLATableT, DTOModelT, CUModelT],
):
