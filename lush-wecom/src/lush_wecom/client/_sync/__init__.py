...
核心功能:
1. 统一的企业微信客户端,整合基础API、外部联系人API、媒体API等
...
from lush_wecom.core.base import WeComClientBase
...
class WeComClient(WeComClientBase):
    """
    ...
    def update_template_card(
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, update_template_card_vo.UpdateTemplateCardResponse, json=json_payload)

    def recall_app_message(self, payload: recall_app_message_vo.RecallAppMessageRequest) -> recall_app_message_vo.RecallAppMessageResponse:
        """
        撤回应用消息
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, recall_app_message_vo.RecallAppMessageResponse, json=json_payload)

    # ===== 网页授权登录API =====
    def auth_get_user_info(self, code: str) -> auth_get_user_info_vo.GetUserInfoResponse:
        """
        获取访问用户身份
        ...
        Returns:
            GetUserInfoResponse: 用户身份信息
        """
        endpoint = "/auth/getuserinfo"
        params = {"code": code}
        return self._make_request("GET", endpoint, auth_get_user_info_vo.GetUserInfoResponse, params=params)

    def auth_get_user_detail(self, user_ticket: str) -> auth_get_user_detail_vo.GetUserDetailResponse:
        """
        获取访问用户敏感信息
        ...
        - 敏感字段需要管理员在应用详情里选择,且成员oauth2授权时确认后才返回
        ...
        Returns:
            GetUserDetailResponse: 用户详细信息
        """
        endpoint = "/auth/getuserdetail"
        json_payload = {"user_ticket": user_ticket}
        return self._make_request("POST", endpoint, auth_get_user_detail_vo.GetUserDetailResponse, json=json_payload)

    # ===== 外部联系人群发API =====

    def add_msg_template(self, payload: add_msg_template_vo.AddMsgTemplateRequest) -> add_msg_template_vo.AddMsgTemplateResponse:
        """
        创建企业群发
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, add_msg_template_vo.AddMsgTemplateResponse, json=json_payload)

    def remind_groupmsg_send(
        self, payload: remind_groupmsg_send_vo.RemindGroupMsgSendRequest
    ) -> remind_groupmsg_send_vo.RemindGroupMsgSendResponse:
        """
        提醒成员群发
        参考文档: https://developer.work.weixin.qq.com/document/path/97610
        """
    ...
    def get_groupmsg_list(self, payload: get_groupmsg_list_vo.GetGroupMsgListRequest) -> get_groupmsg_list_vo.GetGroupMsgListResponse:
        """
        获取群发记录列表
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, get_groupmsg_list_vo.GetGroupMsgListResponse, json=json_payload)

    def get_groupmsg_task(self, payload: get_groupmsg_task_vo.GetGroupMsgTaskRequest) -> get_groupmsg_task_vo.GetGroupMsgTaskResponse:
        """
        获取群发成员发送任务列表
        参考文档: https://developer.work.weixin.qq.com/document/path/93338
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, get_groupmsg_task_vo.GetGroupMsgTaskResponse, json=json_payload)
    ...
    def get_groupmsg_send_result(
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, get_groupmsg_send_result_vo.GetGroupMsgSendResultResponse, json=json_payload)

    # ===== 客户朋友圈API =====

    def add_moment_task(self, payload: add_moment_task_vo.AddMomentTaskRequest) -> add_moment_task_vo.AddMomentTaskResponse:
        """
        创建发表任务
        创建客户朋友圈发表任务
        ...
        隐藏规则:
        - 2025.11.18 适用
        1. 三种类型不能同时发, 会报奇怪的错误: errcode: 41065, errmsg: invalid attachments type
        2. 文字(可选)+图片/视频/链接
        3. 最多只能1个视频
        4. 最多只能1个链接
        5. 最多可以发9个图片
        ...
        return self._make_request(
            "POST",
            endpoint,
            add_moment_task_vo.AddMomentTaskResponse,
            json=json_payload,
        )

    def get_moment_task_result(
        ...
        return self._make_request("GET", endpoint, get_moment_task_result_vo.GetMomentTaskResultResponse, params=params)

    def cancel_moment_task(self, payload: cancel_moment_task_vo.CancelMomentTaskRequest) -> cancel_moment_task_vo.CancelMomentTaskResponse:
        """
        停止尚未发送的企业朋友圈任务
    ...
    def get_moment_list(self, payload: get_moment_list_vo.GetMomentListRequest) -> get_moment_list_vo.GetMomentListResponse:
        """
        获取企业全部的客户朋友圈发表记录
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, get_moment_list_vo.GetMomentListResponse, json=json_payload)

    def get_moment_task(self, payload: get_moment_task_vo.GetMomentTaskRequest) -> get_moment_task_vo.GetMomentTaskResponse:
        """
        获取企业发表的朋友圈成员执行情况
        参考文档: https://developer.work.weixin.qq.com/document/path/93333
        """
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, get_moment_task_vo.GetMomentTaskResponse, json=json_payload)
    ...
    def get_moment_customer_list(
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, get_moment_customer_list_vo.GetMomentCustomerListResponse, json=json_payload)
    ...
    def get_moment_send_result(
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, get_moment_send_result_vo.GetMomentSendResultResponse, json=json_payload)
    ...
    def get_moment_comments(
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, get_moment_comments_vo.GetMomentCommentsResponse, json=json_payload)

    def list_moment_strategies(
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, list_moment_strategy_vo.ListMomentStrategyResponse, json=json_payload)

    def get_moment_strategy(
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, get_moment_strategy_vo.GetMomentStrategyResponse, json=json_payload)

    def get_moment_strategy_range(
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, get_moment_strategy_range_vo.GetMomentStrategyRangeResponse, json=json_payload)

    def create_moment_strategy(
        ...
        json_payload = payload.model_dump(exclude_none=True)
        return self._make_request("POST", endpoint, create_moment_strategy_vo.CreateMomentStrategyResponse, json=json_payload)

    def edit_moment_strategy(
    ...
    def upload_temporary_media(self, file_path: str, media_type: str) -> upload_temporary_media_vo.UploadTemporaryMediaResponse:
        """
        上传临时素材文件到企业微信
        ...
        if file_path_obj.stat().st_size <= 5:
    ...
    def upload_attachment_media(
        ...
        """
        上传附件资源,用于朋友圈(attachment_type=1)或商品图册(attachment_type=2)
        ...
        normalized_media_type = ensure_attachment_upload_constraints(media_type, attachment_type, file_size)
    ...
    def upload_attachment_media_from_url(
        self,
        media_url: str,
        media_type: Literal["image", "video", "file"],
        attachment_type: AttachmentTypeLiteral,
        ...
        try:
            download_result = self._download_media_from_url(media_url)
            ...
            return self.upload_attachment_media(temp_path, normalized_media_type, attachment_type)
        finally:
            if temp_path and (p := Path(temp_path)).exists():
                with contextlib.suppress(FileNotFoundError, OSError):
                    p.unlink(missing_ok=True)

    def upload_image(self, image_path: str) -> upload_image_vo.UploadImageResponse:
        """
        ...
        if not (5 < file_size <= max_size):
            max_size_mb = max_size // (1024 * 1024)
            raise ValueError(f"图片文件大小必须在 5 字节到 {max_size_mb}MB 之间")

        endpoint = "/media/uploadimg"

        with image_path_obj.open("rb") as f:
            files = {"media": (image_path_obj.name, f)}
            return self._make_request("POST", endpoint, upload_image_vo.UploadImageResponse, files=files)

    def _download_media_from_url(self, media_url: str) -> media_vo.MediaDownloadResult:
        """
        从URL下载媒体文件到临时文件
        ...
        try:
            # 先发送HEAD请求获取文件信息
            head_response = httpx.head(media_url, timeout=10, follow_redirects=True)
            ...
            if "." not in original_filename:
                if "image" in content_type:
                    if "jpeg" in content_type or "jpg" in content_type:
                        ...
                        original_filename += ".jpg"  # 默认
                elif "video" in content_type:
                    if "mp4" in content_type:
                        original_filename += ".mp4"
                    else:
                        original_filename += ".mp4"  # 默认
                elif "audio" in content_type:
                    if "amr" in content_type:
                        original_filename += ".amr"
                    else:
                        original_filename += ".amr"  # 企业微信只支持AMR
                # 普通文件,保持原样或添加通用扩展名
            ...
            try:
                # 下载文件
                with httpx.stream("GET", media_url, timeout=30) as response:
    ...
    def upload_temporary_media_from_url(
        self, media_url: str, media_type: Literal["image", "voice", "video", "file"]
    ) -> upload_temporary_media_vo.UploadTemporaryMediaResponse:
        """
        ...
        try:
            ...
            # 直接使用现有的upload_temporary_media方法
            return self.upload_temporary_media(temp_path, media_type)
    ...
    def upload_image_from_url(self, image_url: str) -> upload_image_vo.UploadImageResponse:
        """
        ...
        try:
            # 下载文件到临时路径
            download_result = self._download_media_from_url(image_url)
            temp_path = download_result.temp_file_path
            content_type = download_result.content_type
            file_size = download_result.file_size

            # 检查文件大小 (图片限制: 5字节到upload_image限制之间)
    ...
    def get_temporary_media(self, media_id: str, chunk_size: int = DEFAULT_CHUNK_SIZE) -> Iterator[bytes]:
        """
        根据media_id获取临时素材文件
    ...
    def get_temporary_media_with_range(
        self,
        media_id: str,
        start_byte: int = 0,
